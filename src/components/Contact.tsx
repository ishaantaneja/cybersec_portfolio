        ...
        <Reveal>
          <div className="rounded-2xl border border-cyan/20 bg-gradient-to-br from-panel via-ink to-panel-2 p-8 sm:p-10 glow-border">
            ...
            <h2 className="mt-3 max-w-xl text-3xl font-semibold tracking-tight text-white sm:text-4xl text-balance">
              Let&apos;s talk SOC Analyst opportunities
            </h2>
            <p className="mt-4 max-w-xl text-muted leading-relaxed">
              Interested in analyst seats where alert triage, investigation discipline, and clear
              documentation matter. Reach out via email, LinkedIn, or TryHackMe.
            </p>
                ...
                return (
                  <a
                    ...
                    {...(channel.external
                      ...
                      : {})}
                    className="card-lift group rounded-xl border border-line/80 bg-ink/70 p-4 transition hover:border-cyan/40"
                  >
